...
for i=6:0.5:8
    ...
    temp_ours=0;
    [Data1,Data2,prelabel1,prelabel2]=Generate_data(n1,n2,nF1,nF2,cpnum,sigma,scale,unsamrate,file_path);%create simulated data
    if sign
    [indPT1,valPT1,indPM1]=produce_random_prior_D1(n1,n2,nF1,nF2,cpnum,percentageD1,file_path); %generate prior knowledge W1
    [indPT2,valPT2,indPM2]=produce_random_prior_D2(n1,n2,nF1,nF2,cpnum,percentageD2,file_path); %generate prior knowledge W2
    [prior_X]=produce_random_prior_D12(n1,n2,nF1,nF2,cpnum,percentageD12,file_path); %generate prior knowledge W12
    sign=0;
    end
    ...
    [c_ours]=do_HOGMMNC(lambda,Data1,Data2,indPT1,valPT1,indPT2,valPT2,prior_X,prelabel1,prelabel2,file_path_name);% run HOGMMNC method
     for j=1:3
